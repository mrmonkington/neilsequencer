...
inline void LfoRateDesc(char *buf, unsigned char lforate)
{
	if (lforate<240)
...
inline float CalcLFO(int nShape, float LFOPhase)
{
  ...
  switch(nShape)
  {
    ...
    case 6: LFO=(float)sin(Phs*2*pow((float)2.0,cos(Phs))); break;
    case 7: LFO=(float)sin(Phs*pow((float)4.0,sin(Phs))); break;
    ...
    case 11: LFO=(float)(0.125*f2i(((Phs-PI)/PI-0.5f)*2.0f*4.0)+0.5*fmod(Phs,(float)PI/4)/(PI/4)); break;
    case 12: LFO=(float)(-0.125*f2i(((Phs-PI)/PI-0.5f)*2.0f*4.0)+0.5*fmod(Phs,(float)PI/4)/(PI/4)); break;
    case 13: LFO=(float)(0.125*f2i(((Phs-PI)/PI-0.5f)*2.0f*4.0)+0.5*fmod((float)(2.0*PI-Phs),(float)PI/4)/(PI/4)); break;
    case 14: LFO=(float)(-0.125*f2i(((Phs-PI)/PI-0.5f)*2.0f*4.0)+0.5*fmod((float)(2.0*PI-Phs),(float)PI/4)/(PI/4)); break;
    case 15: LFO=(float)(0.5*(sin(19123*f2i(LFOPhase*8/PI)+40*sin(12.0*f2i(LFOPhase*8/PI))))); break; // 8 zmian/takt
    case 16: LFO=(float)(0.5*(sin(1239543*f2i(LFOPhase*4/PI)+40*sin(15.0*f2i(LFOPhase*16/PI))))); break; // 8 zmian/takt
  }
  return LFO;
}
