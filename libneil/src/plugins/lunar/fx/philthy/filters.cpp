...
{
    int sr = transport->samples_per_second;
  ...
  m_filter.rbjLPF(cf/3.0f,fQ,sr,sqrt(0.707f)/sqrt(fQ));
  m_filter2.rbjLPF(2.0f*cf/3.0f,fQ/2,sr);
  m_filter3.rbjLPF(cf,fQ/3,sr);
}
...
void C6thOrderFilter::CalcCoeffs2() // 6L Separated
{
  ...
  m_filter.rbjLPF(cf,fQ,sr,0.3f/pow((float)(fQ/2.50f), (float)0.05));
  m_filter2.rbjLPF(cf*(1-sep),fQ,sr);
  m_filter3.rbjLPF(std::min(cf*(1+sep),21000.0f),fQ,sr);
}
...
void C6thOrderFilter::CalcCoeffs3() // 6L HiSquelch
{
  ...
  m_filter.rbjLPF(cf,fQ,sr,0.6f/pow((float)std::max(fQ,(float)1.0f), (float)1.7));
  m_filter2.rbjLPF(cf,fQ,sr);
  m_filter3.rbjLPF(cf,fQ,sr);
}
...
void C6thOrderFilter::CalcCoeffs4() // 4L Skull D
{
  ...
  m_filter.rbjLPF(cf,0.707,sr,0.50f);
  m_filter2.rbjLPF(cf,0.707,sr);
  m_filter3.SetParametricEQ(cf,fQ*4,fQ*2.0f,sr);
}
...
void C6thOrderFilter::CalcCoeffs5() // 4L TwinPeaks
{
  ...
  m_filter.rbjLPF(cf,fQ,sr,0.3f/std::max((float)sqrt(fQ)*fQ,(float)1.0));
  m_filter2.rbjLPF(cf,fQ,sr);
  m_filter3.SetParametricEQ(cf/2,3*(fQ-0.7)+1,8*(fQ-0.7)+1,sr);
}
...
void C6thOrderFilter::CalcCoeffs6() // 4L Killah
{
  ...
  m_filter.rbjLPF(cf/1.41,fQ,sr,0.6f/std::max((float)sqrt(fQ)*fQ,(float)1.0));
  m_filter2.rbjLPF(std::min(cf*1.41,22000.0),fQ,sr);
  m_filter3.SetParametricEQ(cf,16/fQ,fQ*4.0f,sr);
}
...
void C6thOrderFilter::CalcCoeffs7() // 4L Phlatt
{
  ...
  m_filter.rbjLPF(cf,fQ,sr,0.8f/std::max((float)fQ,(float)1.0f));
  m_filter2.rbjLPF(cf,fQ,sr);
  m_filter3.rbjBRF(cf,fQ,sr);
}
...
void C6thOrderFilter::CalcCoeffs8() // 2L phlatt
{
  ...
  m_filter.rbjLPF(cf,1.007,sr,float(0.8f/std::max((float)sqrt(fQ),(float)1.0)));
  m_filter2.rbjBRF(cf*0.707,fQ/2,sr);
  m_filter3.rbjBRF(cf,fQ/2,sr);
}
...
void C6thOrderFilter::CalcCoeffs9() // 2L FrontFlt
{
  ...
  m_filter.rbjLPF(cf,2*fQ,sr,float(0.3f/std::max((float)sqrt(fQ),(float)1.0)));
  m_filter2.SetParametricEQ(cf/2,3*(fQ-0.7)+1,3*(fQ-0.7)+1,sr);
  m_filter3.SetParametricEQ(cf/4,3*(fQ-0.7)+1,3*(fQ-0.7)+1,sr);
}
...
void C6thOrderFilter::CalcCoeffs10() // 2L LaserOne
{
  ...
  m_filter.rbjLPF(cf,2*fQ,sr,float(0.15f/std::max((float)sqrt(fQ),(float)1.0)));
  m_filter2.SetParametricEQ(cf*3/4,2*(fQ-0.7)+1,3*(fQ-0.7)+1,sr);
  m_filter3.SetParametricEQ(cf/2,2*(fQ-0.7)+1,3*(fQ-0.7)+1,sr);
}
...
void C6thOrderFilter::CalcCoeffs11() // 2L FMish
{
  ...
  m_filter.rbjLPF(cf,2*fQ,sr,0.2f/std::max((float)sqrt(fQ),(float)1.0));
  m_filter2.SetParametricEQ(cf*sc1,2*(fQ-0.7)+1,3*(fQ-0.7)+1,sr);
  m_filter3.SetParametricEQ(cf*sc2,2*(fQ-0.7)+1,3*(fQ-0.7)+1,sr);
}
...
void C6thOrderFilter::CalcCoeffs12()
{
  ...
  m_filter.rbjBRF(cf,q,sr);
  m_filter2.rbjBRF(cf/spacing,q,sr);
  m_filter3.rbjBRF(std::min(21000.0f,cf*spacing),q,sr);
}
...
void C6thOrderFilter::CalcCoeffs13()
{
  ...
  //float q=3.6f;
  float spacing=(float)pow((float)(1.3f+3*(240-Resonance)/240.0),(float)(1-cf/20000.0f));
  m_filter.rbjHPF(cf,q,sr,0.71/(pow(q,(float)0.7)));
  m_filter2.rbjHPF(cf/spacing,q,sr);
  m_filter3.rbjHPF(std::min(21000.0f,cf*spacing),q,sr);
}
...
void C6thOrderFilter::CalcCoeffs14()
{
  ...
  //float q=3.6f;
  m_filter.rbjBPF(cf,q,sr,pow(q,(float)0.7)/1.7f);
  m_filter2.rbjBPF(cf*0.9,q,sr);
  m_filter3.rbjBPF(std::min(21000.0,cf*1.01),q,sr);
}
...
void C6thOrderFilter::CalcCoeffs15()
{
  ...
  //float q=3.6f;
  m_filter.SetParametricEQ(float(cf/4),1,q,sr,float(0.25/sqrt(q)));
  m_filter2.SetParametricEQ(float(cf/2),2,float(1/q),sr);
  m_filter3.SetParametricEQ(cf,1,q,sr);
}
...
void C6thOrderFilter::CalcCoeffs16()
{
  ...
  m_filter.SetParametricEQ(Cutoff1,2.5,q,sr,float(1.0/q));
  m_filter2.rbjLPF(Cutoff2*1.2,sqrt(q),sr);
  m_filter3.SetParametricEQ(Cutoff2,2.5,sqrt(q),sr);
}
