#ifndef GERSHON_SPECTOGRAM_HPP
#define GERSHON_SPECTOGRAM_HPP
...
class Spectogram : public zzub::plugin, public zzub::event_handler {
private:
  GtkWidget *window;
...
public:
  ...
  static gboolean on_checkbutton_toggled(GtkWidget *widget, gpointer user_data);
  static gboolean timer_handler(Spectogram* r);
};

struct SpectogramInfo : zzub::info {
  SpectogramInfo() {
    this->flags = zzub::plugin_flag_has_audio_input | zzub::plugin_flag_has_audio_output | zzub::plugin_flag_has_custom_gui;
    this->name = "Spectogram Analyzer";
    this->short_name = "Spectogram";
    this->author = "gershon";
    this->uri = "@libneil/gershon/gfx/Spectogram";       
  }
  virtual zzub::plugin* create_plugin() const { return new Spectogram(); }
  virtual bool store_info(zzub::archive *data) const { return false; }
} MachineInfo;

struct Spectogram_PluginCollection : zzub::plugincollection {
...
zzub::plugincollection *zzub_get_plugincollection() {
  return new Spectogram_PluginCollection();
}

#endif // GERSHON_SPECTOGRAM_HPP
